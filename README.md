...
Number of absences  
Marks in M1 (Internal Exam 1)  
Marks in M2 (Internal Exam 2)  
Determines Pass/Fail using a threshold of 33 marks.  
Assigns grades based on predicted marks:  
A: ≥ 90 → Excellent  
B: 75–89 → Very Good  
C: 55–74 → Good  
D: 33–54 → Average (Pass)  
F: < 33 → Fail  
...
6.View output  
The program will show the predicted final marks, Pass/Fail status, and grade. 
